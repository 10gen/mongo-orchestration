...
CERTS = None # REPLACE WITH THE PATH TO YOUR *.pem FILES IF YOU WANT SSL SUPPORT
...
if __name__ == '__main__':
    ...
    if argv_has('ssl') or argv_has('tls'):
        if not CERTS:
            raise NotImplementedError("You need to change the CERTS variable to point to your *.pem files!")
